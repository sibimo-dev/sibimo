{{--
    ...
    Isi kolom letter_types.blade_view dengan: letters.surat-keterangan-jalan

    Data yang dipakai (dibentuk oleh LetterPdfService::viewData):
      $nomor, $signer, $applicant (name, birth, nik, kk_number, gender,
      marital_status, religion, occupation, address, rt, rw, phone),
      $destination, $purpose, $signature
--}}
